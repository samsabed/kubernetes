...
func (s *kubeStore) LoadMap(bucketName string, newFactory func() interface{}) (map[string]interface{}, error) {
	if s.db == nil {
		return nil, fmt.Errorf("kubestore not ready")
	}
